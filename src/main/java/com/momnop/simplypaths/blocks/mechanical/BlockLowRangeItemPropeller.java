...
public class BlockLowRangeItemPropeller extends Block implements
		ITileEntityProvider {
	
	@SideOnly(Side.CLIENT)
	public static IIcon blockTop;

	public BlockLowRangeItemPropeller(Material material,
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityLowRangeItemPropeller();
	}
}