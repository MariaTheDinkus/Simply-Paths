...
public class BlockHighRangeItemPropeller extends Block implements
		ITileEntityProvider {
	
	@SideOnly(Side.CLIENT)
	public static IIcon blockTop;

	public BlockHighRangeItemPropeller(Material material,
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityHighRangeItemPropeller();
	}
}